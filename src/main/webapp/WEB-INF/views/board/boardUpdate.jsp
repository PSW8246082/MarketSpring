 ...
 <div id="board_write">
    ...
    <hr><br>
        <div id="write_area">
			...
			<div id="in_title">
	     		<p>작성자</p><textarea name="boardWriter" id="utitle" rows="1" cols="55" readonly>${requestScope.board.boardWriter }</textarea>
			</div>
			<div id="in_title">
			    <p>제목<b>*</b></p><textarea name="boardTitle" id="utitle" rows="1" cols="55" placeholder="제목을 입력해주세요." maxlength="100" required>${board.boardTitle }</textarea>
			</div>
			<div class="wi_line"></div>
			<div id="in_content">
			    <p>내용<b>*</b></p><textarea name="boardContent" id="ucontent" placeholder="내용을 입력해주세요." required>${board.boardContent }</textarea>
			</div>
			<div id="select">
			<label for="file">
			    <div class="btn-upload">파일 업로드하기</div>
			</label>
			<input type="file" name="bploadFile" id="file">
			   <div class="bt_se">
...
<!-- 				<li> -->
<!-- 				<label>제목</label> -->
<%-- 				<input type="text" id="" name="noticeSubject" value=${board.noticeSubject }> --%>
<!-- 				</li> -->
<!-- 				<li> -->
<!-- 				<label>내용</label> -->
<%-- 				<textarea rows="30" cols="40"  id="" name="noticeContent">${board.noticeContent }</textarea> --%>
<!-- 				</li> -->
<!-- 			</ul> -->
<!-- 		</fieldset> -->
<!-- 		<div> -->
